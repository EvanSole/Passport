 ...
 */
public class UsersDTO extends BasePO implements Serializable {
    ...
    private boolean booleanIsActive;

    public boolean isBooleanIsActive() {
        return booleanIsActive;
    }

    public void setBooleanIsActive(boolean booleanIsActive) {
